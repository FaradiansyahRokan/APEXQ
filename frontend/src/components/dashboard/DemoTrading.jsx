                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 0, background: 'var(--surface2)', borderRadius: 10, overflow: 'hidden', border: '1px solid var(--border)', marginBottom: 12 }}>
                    {[
                      ...
                      <div key={label} style={{ textAlign: 'center', padding: '12px 6px', borderRight: '1px solid var(--border)' }}>
                        <p style={{ fontFamily: 'var(--mono)', fontSize: 6, color: 'var(--ink4)', marginBottom: 5, letterSpacing: '0.10em', textTransform: 'uppercase' }}>{label}</p>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 8, marginBottom: 12 }}>
                    {[
                      ...
                      <div key={label} style={{ background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 12px' }}>
                        <p style={{ fontFamily: 'var(--mono)', fontSize: 6, color: 'var(--ink4)', letterSpacing: '0.10em', textTransform: 'uppercase', marginBottom: 4 }}>{label}</p>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 8 }}>
                        {[
                          ...
                          <div key={label} style={{ textAlign: 'center' }}>
                            <p style={{ fontFamily: 'var(--mono)', fontSize: 6, color: 'var(--ink4)', letterSpacing: '0.10em', textTransform: 'uppercase', marginBottom: 3 }}>{label}</p>
                            <p style={{ fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700, color }}>{value}</p>
                          </div>
                        ))}
                      </div>
                ...
                <div>
                  {form.orderType === 'MARKET' ? (
                    ...
                    <>
                      ...
                      <p style={{ fontFamily: 'var(--mono)', fontSize: 6, color: 'var(--amber)', marginTop: 3 }}>Eksekusi otomatis saat harga menyentuh limit</p>
                    </>
                  )}
                </div>
                <div>
                  ...
                  <p style={{ fontFamily: 'var(--mono)', fontSize: 6, color: 'var(--ink4)', marginTop: 3 }}>Auto-closes on hit</p>
                </div>
                <div>
                    ...
                    return (
                      <div key={pos.id} style={{ display: 'grid', gridTemplateColumns: '80px 54px 100px 90px 100px 110px 80px 1fr', padding: '12px 16px', borderBottom: '1px solid var(--border)', alignItems: 'center', gap: 4, background: unrPnl > 0 ? '#16a34a04' : unrPnl < 0 ? '#dc262604' : 'transparent' }}>
                        <div>
                          ...
                          {pos.signal !== '—' && <span className={`badge ${pos.signal === 'BULLISH' ? 'badge-green' : 'badge-red'}`} style={{ fontSize: 6 }}>{pos.signal}</span>}
                        </div>
            ...
            <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 13, overflow: 'hidden' }}>
              <div style={{ padding: '14px 18px', borderBottom: '1px solid var(--border)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span className="badge badge-accent" style={{ fontSize: 6 }}>Hyperliquid</span>
                </div>
              </div>
